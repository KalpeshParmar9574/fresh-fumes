...
import { EDUCATION } from "../../../constants/masters";
...
export const insert = createAsyncThunk(
	...
	async (body, { rejectWithValue }) => {
		try {
			const res = await Axios.post(EDUCATION, body);
...
export const deleteById = createAsyncThunk(
	...
	async (id, { rejectWithValue }) => {
		try {
			const res = await Axios.delete(`${EDUCATION}/`, {
				headers: { id: id },
			});
			toast.success(res.data.message);
			return res.data;
...
export const updateById = createAsyncThunk(
	...
	async (body, { rejectWithValue }) => {
		try {
			const res = await Axios.put(`${EDUCATION}/`, body, {
				headers: { id: body.id },
			});
			toast.success(res.data.message);
			return res.data;
